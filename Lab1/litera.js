	...
	function startGL() {
		...
		/*let vertexPosition = [
			//Top
				...
				-1.25, +2.0, -0.0,  -1.25, 1.25 , +0.0,  -0.5, +2.0, +0.0,
				-0.5, +1.25, -0.0,  -1.25, 1.25 , +0.0,  -0.5, +2.0, +0.0,

				-0.5, +1.25, -0.0,   0.25, +1.25, +0.0,  -0.5, +2.0 , +0.0,  

				-0.5, +1.25, -0.0,   0.25, +1.25, +0.0,  -0.5, -1 , +0.0,  
				+0.25, -1.0, -0.0,   0.25, +1.25, +0.0,  -0.5, -1 , +0.0,

				-1.25, -1.75, -0.0,  -1.25, -1 , +0.0,  -0.5, -1.0, +0.0,
				-1.25, -1.75, -0.0,  -0.5, -1.75 , +0.0,  -0.5, -1.0, +0.0,
			...
			vertexPositionBuffer.numItems = 10; //Zdefinoiowanie liczby punktów w naszym buforze
